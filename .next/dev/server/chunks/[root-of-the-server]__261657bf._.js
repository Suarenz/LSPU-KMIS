...
"[project]/app/api/documents/[id]/view-proxy/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        let authResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$middleware$2f$auth$2d$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireAuth"])(request);
        ...
        if ('status' in authResult) {
            ...
            if (token) {
                ...
                authResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$middleware$2f$auth$2d$middleware$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireAuth"])(modifiedRequest);
        ...
        // Get the document
        const document = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$document$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].getDocumentById(id, user.id);
        if (!document) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        // Get signed URL
        const signedUrl = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$file$2d$storage$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].getFileUrl(fileName);
        ...
        console.error('Error in view proxy:', error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__261657bf._.js.map