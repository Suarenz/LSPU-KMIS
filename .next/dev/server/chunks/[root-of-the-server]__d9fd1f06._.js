...
async function GET(request, { params }) {
    try {
        ...
        let userId;
        try {
            const payload = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$jwt$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].verifyToken(token);
            if (!payload) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        let fileName;
        const docWithBlob = document; // Type assertion to access Prisma fields
        ...
        try {
            ...
            if (ext === 'pdf') contentType = 'application/pdf';
                ...
                'jpg',
                'jpeg'
            ].includes(ext)) contentType = 'image/jpeg';
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d9fd1f06._.js.map