...
async function GET(request) {
    ...
    try {
        ...
        if (user.role === 'ADMIN') {
            ...
            const categories = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].document.groupBy({
                by: [
                    'category'
                ],
                _count: {
            ...
            const topDocs = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].document.findMany({
                orderBy: {
                    downloadsCount: 'desc'
                },
                take: 5,
            ...
            const recentDocs = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].document.findMany({
                orderBy: {
                    createdAt: 'desc'
                },
                take: 10,
            ...
            const userWithUnit = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.findUnique({
                where: {
                    id: user.id
                },
                select: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__35e2faa0._.js.map