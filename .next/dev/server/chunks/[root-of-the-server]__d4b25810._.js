...
async function GET(request) {
    try {
        ...
        const units = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].unit.findMany({
            orderBy: {
                name: 'asc'
            }
        });
...
async function POST(request) {
    try {
        ...
        const formattedCode = code ? code.toUpperCase().trim().replace(/\s+/g, ' ') // Replace multiple spaces with single space
         : undefined;
        const unit = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].unit.create({
            data: {
                name,
                code: formattedCode,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d4b25810._.js.map