...
class ColivaraService {
    ...
    async performSemanticSearch(query, filters, userId) {
        try {
            ...
            const results = response.results.map((item)=>{
                ...
                const extractedContent = item.chunk || item.content || item.text || item.page_content || item.metadata?.content || item.metadata?.text || item.document?.content || item.document?.text || '';
                ...
                return {
                    ...
                    pageNumbers: [
                        item.page_number
                    ].filter(Boolean) || item.page_numbers || item.pageNumbers || item.pages || [],
    ...
    async indexDocument(documentId, base64Content) {
      ...
      `;
            ...
            console.log('[Colivara] Upload result from upsertDocument:', {
                colivaraDocId,
                documentId
            });
   ...
   */ async getDocumentById(id, userId) {
        try {
            ...
            return {
                ...
                blobName: document.blobName ?? undefined,
   ...
   */ async getDocumentByColivaraId(colivaraDocumentId, userId) {
        try {
            ...
            return {
                ...
                blobName: dbDocument.blobName ?? undefined,
...
"[project]/app/api/documents/[id]/preview/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        if (!id || typeof id !== 'string' || id.trim() === '' || id.includes('undefined') || id.includes('.pdf') && !id.includes('_') || id.includes('.docx') && !id.includes('_') || id.includes('.xlsx') && !id.includes('_') || id.includes('.pptx') && !id.includes('_') || id.includes('.jpg') && !id.includes('_') || id.includes('.jpeg') && !id.includes('_') || id.includes('.png') && !id.includes('_')) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        let document = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$document$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].getDocumentById(id, userId);
        ...
        if (!document) {
            ...
            document = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$document$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].getDocumentByColivaraId(id, userId);
        }
        if (!document) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const containerName = document.isQproDocument || document.category === 'QPRO' ? 'qpro-files' : 'repository-files';
        try {
            console.log('Getting file URL for:', {
                fileName,
                containerName
            ...
            const previewUrl = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$file$2d$storage$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].getFileUrl(fileName, containerName);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5b0477d9._.js.map