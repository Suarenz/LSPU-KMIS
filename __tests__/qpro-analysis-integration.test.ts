            ...
            activities: [
              {
                ...
                achievement: 80.0,
                status: 'MISSED',
                authorizedStrategy: 'collaborate with industry experts, tech companies and research institutions',
                aiInsight: 'Insight',
                prescriptiveAnalysis: 'Prescriptive analysis based on authorized strategy',
                confidence: 0.85,
                unit: 'College of Engineering',
              },
            ],
  ...
  describe('Analysis Storage Formatting', () => {
    it('should format analysis output as readable markdown', () => {
      const mockAnalysis: QPROAnalysisOutput = {
        activities: [
          {
            ...
            achievement: 80.0,
            status: 'MISSED',
            authorizedStrategy: 'collaborate with industry experts to design relevant course content',
            aiInsight: 'Performance gap identified: 8 achieved vs 10 target (80% achievement).',
            prescriptiveAnalysis: 'To close this gap, immediately implement the authorized strategy.',
            confidence: 0.85,
            unit: 'College of Engineering',
          },
        ],
        ...
        documentInsight: 'Test document insight',
        prescriptiveItems: [],
        alignment: 'Test alignment',
        opportunities: 'Test opportunities',
        gaps: 'Test gaps',
