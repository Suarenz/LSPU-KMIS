...
async function GET(request) {
    try {
        ...
        const permissionsData = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].documentPermission.findMany({
            where: {
                userId: user.id
            },
            select: {
        ...
        if (permissionsData) {
            ...
            permissions = permissionsData.reduce((acc, perm)=>{
                acc[perm.documentId] = perm.permission;
                return acc;
            }, {});
        }
        // Get user's recent activity
        const recentActivity = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].documentView.findMany({
            where: {
                userId: user.id
            },
            select: {
...
async function POST(request) {
    try {
        ...
        console.log('User preferences update request:', {
            userId: user.id,
            preferences
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4eea37c6._.js.map