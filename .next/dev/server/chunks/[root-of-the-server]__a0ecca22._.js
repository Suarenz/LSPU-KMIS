...
"[project]/lib/services/qpro-cache-service.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
class QProCacheService {
    config = {
        uploadCacheTtl: 60 * 60,
        analysisCacheTtl: 24 * 60 * 60,
        processingStatusTtl: 30 * 60
    };
    constructor(config){
        if (config) {
            this.config = {
   ...
   */ generateUploadCacheKey(documentId) {
        return `qpro:upload:${documentId}`;
    }
    /**
   * Generate cache key for QPRO analysis
   */ generateAnalysisCacheKey(documentId) {
        return `qpro:analysis:${documentId}`;
    }
    /**
   * Generate cache key for QPRO processing status
   */ generateProcessingStatusCacheKey(analysisId) {
        return `qpro:processing:${analysisId}`;
    }
    /**
   * Generate cache key for user's QPRO analyses list
   */ generateUserAnalysesCacheKey(userId) {
        return `qpro:user:${userId}:analyses`;
    }
    /**
   * Cache upload metadata
   */ async cacheUpload(uploadData) {
        try {
            const cacheKey = this.generateUploadCacheKey(uploadData.documentId);
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$redis$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redisService"].set(cacheKey, uploadData, this.config.uploadCacheTtl);
   ...
   */ async getUploadCache(documentId) {
        try {
            const cacheKey = this.generateUploadCacheKey(documentId);
            const cached = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$redis$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redisService"].get(cacheKey);
            if (cached) {
   ...
   */ async cacheAnalysis(analysisData) {
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$redis$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redisService"].set(cacheKey, dataWithTimestamp, this.config.analysisCacheTtl);
   ...
   */ async getAnalysisCache(documentId) {
        try {
   ...
   */ async updateProcessingStatus(analysisId, status, progress) {
        try {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$redis$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redisService"].set(cacheKey, statusData, this.config.processingStatusTtl);
   ...
   */ async getProcessingStatus(analysisId) {
        try {
            const cacheKey = this.generateProcessingStatusCacheKey(analysisId);
            const cached = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$redis$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redisService"].get(cacheKey);
            if (cached) {
   ...
   */ async cacheUserAnalyses(userId, analyses) {
        try {
            const cacheKey = this.generateUserAnalysesCacheKey(userId);
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$redis$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redisService"].set(cacheKey, {
                analyses,
                timestamp: Date.now()
            }, this.config.analysisCacheTtl);
   ...
   */ async getUserAnalysesCache(userId) {
        try {
            const cacheKey = this.generateUserAnalysesCacheKey(userId);
            const cached = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$redis$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redisService"].get(cacheKey);
            if (cached) {
   ...
   */ async invalidateUploadCache(documentId) {
        try {
            const cacheKey = this.generateUploadCacheKey(documentId);
   ...
   */ async invalidateAnalysisCache(documentId) {
        try {
            const cacheKey = this.generateAnalysisCacheKey(documentId);
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$redis$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redisService"].del(cacheKey);
   ...
   */ async invalidateProcessingStatus(analysisId) {
        try {
            const cacheKey = this.generateProcessingStatusCacheKey(analysisId);
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$redis$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redisService"].del(cacheKey);
   ...
   */ async invalidateUserAnalysesCache(userId) {
        try {
            const cacheKey = this.generateUserAnalysesCacheKey(userId);
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$redis$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redisService"].del(cacheKey);
        ...
        try {
            ...
            if (keys.length > 0) {
                for (const key of keys){
                    await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$redis$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redisService"].del(key);
                }
   ...
   */ async getCacheStats() {
        try {
            const keys = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$redis$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["redisService"].keys('qpro:*');
            return {
                size: keys.length,
                keys
            };
...
const qproCacheService = new QProCacheService();
;
}),
"[project]/app/api/qpro/analyses/[id]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$qpro$2d$cache$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/services/qpro-cache-service.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/prisma.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$qpro$2d$aggregation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/utils/qpro-aggregation.ts [app-route] (ecmascript)");
;
;
...
async function GET(request, { params }) {
    try {
        ...
        // Check cache first
        const cachedAnalysis = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$qpro$2d$cache$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["qproCacheService"].getAnalysisCache(id);
        if (cachedAnalysis) {
        ...
        // Get analysis by ID
        const analysis = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$qpro$2d$analysis$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["qproAnalysisService"].getQPROAnalysisById(id);
        if (!analysis) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        console.log(`[QPRO Analysis Detail] activities count:`, analysis.activities?.length || 0);
        console.log(`[QPRO Analysis Detail] kras count:`, analysis.kras?.length || 0);
        ...
        if (analysis.prescriptiveAnalysis) {
            ...
            console.log(`[QPRO Analysis Detail] prescriptiveAnalysis keys:`, typeof analysis.prescriptiveAnalysis === 'object' ? Object.keys(analysis.prescriptiveAnalysis) : 'N/A');
        }
        // Debug: Log first activity
        if (analysis.activities && Array.isArray(analysis.activities) && analysis.activities.length > 0) {
            const firstAct = analysis.activities[0];
        ...
        if (analysis.kras && Array.isArray(analysis.kras) && analysis.kras.length > 0) {
            const firstKra = analysis.kras[0];
        ...
        const response = {
            ...
            prescriptiveAnalysis: formatPrescriptiveAnalysisForFrontend(analysis.prescriptiveAnalysis && Object.keys(analysis.prescriptiveAnalysis).length > 0 ? analysis.prescriptiveAnalysis : extractPrescriptiveFromKRAs(analysis.kras)),
...
function extractSections(analysis) {
    ...
    if (sectionMap.size === 0) {
        ...
        sections.push({
            ...
            activities: [
                'Alumni employment and career tracking'
            ]
        });
    } else {
...
function formatKRAClassifications(analysis) {
    ...
    if (!activitiesHaveKraId && analysis.kras && Array.isArray(analysis.kras)) {
        ...
        analysis.kras.forEach((kra)=>{
            ...
            embeddedActivities.forEach((act)=>{
        ...
        if (totalEmbeddedCount === 0 && analysis.activities && Array.isArray(analysis.activities)) {
            const topLevelCount = analysis.activities.length;
    ...
    return analysis.kras.map((kra, idx)=>{
        const kraId = kra.kraId || kra.id || '';
        ...
        const achievements = kraAchievements[kraId] || [];
        const avgAchievement = achievements.length > 0 ? achievements.reduce((a, b)=>a + b, 0) / achievements.length : kra.achievementRate || 0;
...
function organizeActivitiesByKRA(analysis) {
    const organized = {};
    const strategicPlanJson = __turbopack_context__.r("[project]/lib/data/strategic_plan.json (json)");
    const allKRAs = strategicPlanJson.kras || [];
    const getInitiativeTargetType = (kraId, initiativeId)=>{
        if (!kraId || !initiativeId) return null;
        // Use normalized KRA ID for consistent lookup
        const normalizedKraIdVal = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$qpro$2d$aggregation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["normalizeKraId"])(kraId);
        const kra = allKRAs.find((k)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$qpro$2d$aggregation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["normalizeKraId"])(k.kra_id) === normalizedKraIdVal);
    ...
    const computeGroupTotals = (kraId, activities, year, fallbackInitiativeId)=>{
        const initiativeIds = activities.map((a)=>a.initiativeId).filter(Boolean).map((v)=>String(v));
        ...
        const meta = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$qpro$2d$aggregation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getInitiativeTargetMeta"])({
            kras: allKRAs
        }, kraId, primaryInitiativeId, year);
        const fallbackTarget = typeof activities?.[0]?.initiativeTarget === 'number' ? activities[0].initiativeTarget : typeof activities?.[0]?.target === 'number' ? activities[0].target : Number(activities?.[0]?.target || 0);
        const targetValue = meta.targetValue ?? (Number.isFinite(fallbackTarget) && fallbackTarget > 0 ? fallbackTarget : 0);
        const aggregated = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$utils$2f$qpro$2d$aggregation$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["computeAggregatedAchievement"])({
            targetType: meta.targetType,
            targetValue,
    ...
    if (useEmbeddedActivities && analysis.kras && Array.isArray(analysis.kras)) {
        ...
        if (totalEmbedded === 0 && analysis.activities && Array.isArray(analysis.activities) && kras.length === 1) {
            const kra = kras[0];
            const kraId = kra.kraId || kra.id;
            console.log(`[ORGANIZE] Fallback: assigning ${analysis.activities.length} top-level activities to single KRA: ${kraId}`);
            organized[kraId] = {
                kraId,
            ...
            organized[kraId].status = organized[kraId].completionPercentage >= 100 ? 'MET' : organized[kraId].completionPercentage >= 70 ? 'ON_TRACK' : organized[kraId].completionPercentage > 0 ? 'PARTIAL' : 'NOT_STARTED';
    ...
    console.log(`[ORGANIZE] Processing ${analysis.activities.length} activities from top-level`);
    analysis.activities.forEach((activity)=>{
        // Try multiple field paths for kraId
        const kraId = activity.kraId || activity.kra_id || activity.kra || 'UNCLASSIFIED';
    ...
    Object.keys(organized).forEach((compositeKey)=>{
        ...
        if (kra.totalTarget > 0) {
            ...
            const avgAchievement = kra.activities.reduce((sum, act)=>sum + act.achievement, 0) / kra.activities.length;
...
function parseInsights(analysisResult) {
 ...
 */ function extractPrescriptiveFromKRAs(kras) {
    ...
    kras.forEach((kra)=>{
        ...
        if (kra.prescriptiveAnalysis || kra.rootCause || kra.actionItems?.length > 0) {
            extracted[kraId] = {
                ...
                missedActivities: (kra.activities || []).filter((act)=>act.status === 'MISSED' || act.achievement !== undefined && act.achievement < 100).map((act)=>({
                        name: act.name,
 ...
 */ function formatPrescriptiveAnalysisForFrontend(prescriptiveAnalysis) {
    if (!prescriptiveAnalysis) return null;
    // New document-level format (single insight + single prescriptive string)
    if (typeof prescriptiveAnalysis === 'object' && (typeof prescriptiveAnalysis.documentInsight === 'string' || typeof prescriptiveAnalysis.prescriptiveAnalysis === 'string' || Array.isArray(prescriptiveAnalysis.prescriptiveItems))) {
    ...
    if (typeof prescriptiveAnalysis === 'string') {
        return {
            recommendations: prescriptiveAnalysis
        };
    }
    ...
    const allMissedActivities = [];
    entries.forEach((entry)=>{
        if (entry.prescriptiveAnalysis) {
            const kraTitle = entry.kraTitle || entry.kraId || 'General';
            const achievementStr = entry.achievementRate !== undefined ? ` (${entry.achievementRate.toFixed(1)}% achievement)` : '';
        ...
        if (entry.missedActivities && Array.isArray(entry.missedActivities)) {
            ...
            entry.missedActivities.forEach((act)=>{
...
async function PATCH(request, { params }) {
    try {
        ...
        const existingAnalysis = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].qPROAnalysis.findUnique({
            where: {
                id: analysisId
            }
        });
        ...
        if (activities && Array.isArray(activities)) {
            ...
            const metActivities = formattedActivities.filter((a)=>a.status === 'MET').length;
            const avgAchievement = totalActivities > 0 ? formattedActivities.reduce((sum, a)=>sum + (a.achievement || 0), 0) / totalActivities : 0;
        ...
        if (kras && Array.isArray(kras)) {
            ...
            const rebuiltKras = Array.from(kraMap.values()).map((kra)=>({
                    ...kra,
                    achievementRate: kra.totalTarget > 0 ? Math.round(kra.totalReported / kra.totalTarget * 100 * 100) / 100 : 0,
        ...
        // Update the analysis
        const updatedAnalysis = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].qPROAnalysis.update({
            where: {
                id: analysisId
            },
            data: updateData
        ...
        if (activities && Array.isArray(activities)) {
            for (const act of activities){
                await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].aggregationActivity.updateMany({
                    where: {
        ...
        // Invalidate cache
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$qpro$2d$cache$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["qproCacheService"].invalidateAnalysisCache(analysisId);
        if (existingAnalysis.uploadedById) {
            await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$qpro$2d$cache$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["qproCacheService"].invalidateUserAnalysesCache(existingAnalysis.uploadedById);
        }
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            ...
            analysis: {
                ...
                activitiesCount: updatedAnalysis.activities?.length || 0,
                krasCount: updatedAnalysis.kras?.length || 0
            }
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a0ecca22._.js.map