   ...
   */ async getAnalytics(userId, userRole) {
        try {
            ...
            if (userId && userRole && userRole !== 'ADMIN' && userRole !== 'FACULTY') {
                ...
                totalDocuments = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].document.count({
                    where: {
                        status: 'ACTIVE',
                ...
                totalDownloads = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].documentDownload.count({
                    where: {
                        document: {
                            uploadedById: userId
                        }
                ...
                totalViews = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].documentView.count({
                    where: {
                        document: {
                            uploadedById: userId
                        }
                ...
                recentDocuments = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].document.findMany({
                    where: {
                        status: 'ACTIVE',
                        uploadedById: userId
                    },
                ...
                popularDocuments = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].document.findMany({
                    where: {
                        status: 'ACTIVE',
                        uploadedById: userId
                    },
                ...
                totalUsers = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].user.count();
                totalDownloads = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].documentDownload.count();
                totalViews = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].documentView.count();
            ...
            const recentActivity = recentDocuments.map((doc, index)=>({
                    id: `${index + 1}`,
                    type: "upload",
                    user: doc.uploadedBy,
            ...
            if (userId && userRole && userRole !== 'ADMIN' && userRole !== 'FACULTY') {
                ...
                try {
                    const rawResult = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].$queryRaw`
            SELECT
              category,
              COUNT(*) as count
            FROM documents
...
const __TURBOPACK__default__export__ = new AnalyticsService();
}),
...
async function GET(request) {
    ...
    try {
        const analytics = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$analytics$2d$service$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].getAnalytics(user.id, user.role);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__65e1b78b._.js.map